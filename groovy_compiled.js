...
lt.plugins.groovy.run_groovy = (function run_groovy(p__8267){var map__8269 = p__8267;var map__8269__$1 = ((cljs.core.seq_QMARK_.call(null,map__8269))?cljs.core.apply.call(null,cljs.core.hash_map,map__8269):map__8269);var info = map__8269__$1;var client = cljs.core.get.call(null,map__8269__$1,new cljs.core.Keyword(null,"client","client",3951159101));var name = cljs.core.get.call(null,map__8269__$1,new cljs.core.Keyword(null,"name","name",1017277949));var path = cljs.core.get.call(null,map__8269__$1,new cljs.core.Keyword(null,"path","path",1017337751));var obj = lt.object.create.call(null,new cljs.core.Keyword("lt.plugins.groovy","connecting-notifier","lt.plugins.groovy/connecting-notifier",2578157599),info);var client_id = lt.objs.clients.__GT_id.call(null,client);var project_dir = lt.objs.files.parent.call(null,path);lt.object.merge_BANG_.call(null,client,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"port","port",1017351155),lt.objs.clients.tcp.port,new cljs.core.Keyword(null,"proc","proc",1017353928),obj], null));
...
lt.plugins.groovy.notify = (function notify(obj){var map__8271 = obj;var map__8271__$1 = ((cljs.core.seq_QMARK_.call(null,map__8271))?cljs.core.apply.call(null,cljs.core.hash_map,map__8271):map__8271);var client = cljs.core.get.call(null,map__8271__$1,new cljs.core.Keyword(null,"client","client",3951159101));var groovy_server = cljs.core.get.call(null,map__8271__$1,new cljs.core.Keyword(null,"groovy-server","groovy-server",2729950548));var path = cljs.core.get.call(null,map__8271__$1,new cljs.core.Keyword(null,"path","path",1017337751));var groovy = cljs.core.get.call(null,map__8271__$1,new cljs.core.Keyword(null,"groovy","groovy",4071405440));if((cljs.core.not.call(null,groovy)) || (cljs.core.empty_QMARK_.call(null,groovy)))
...
lt.plugins.groovy.try_connect = (function try_connect(p__8272){var map__8274 = p__8272;var map__8274__$1 = ((cljs.core.seq_QMARK_.call(null,map__8274))?cljs.core.apply.call(null,cljs.core.hash_map,map__8274):map__8274);var info = cljs.core.get.call(null,map__8274__$1,new cljs.core.Keyword(null,"info","info",1017141280));var path = new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(info);var client = lt.objs.clients.client_BANG_.call(null,new cljs.core.Keyword(null,"groovy.client","groovy.client",3165568285));lt.plugins.groovy.check_all.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"path","path",1017337751),path,new cljs.core.Keyword(null,"client","client",3951159101),client], null));
return client;
});
...
lt.plugins.groovy.__BEH__eval_BANG_ = (function __BEH__eval_BANG_(this$,event){var map__8276 = event;var map__8276__$1 = ((cljs.core.seq_QMARK_.call(null,map__8276))?cljs.core.apply.call(null,cljs.core.hash_map,map__8276):map__8276);var origin = cljs.core.get.call(null,map__8276__$1,new cljs.core.Keyword(null,"origin","origin",4300251800));var info = cljs.core.get.call(null,map__8276__$1,new cljs.core.Keyword(null,"info","info",1017141280));lt.objs.notifos.working.call(null,"Evaluating groovy...");
...
lt.plugins.groovy.notify_of_results = (function notify_of_results(editor,res){var seq__8281 = cljs.core.seq.call(null,new cljs.core.Keyword(null,"result","result",4374444943).cljs$core$IFn$_invoke$arity$1(res));var chunk__8282 = null;var count__8283 = 0;var i__8284 = 0;while(true){
if((i__8284 < count__8283))
{var ln = cljs.core._nth.call(null,chunk__8282,i__8284);var lineNo_8295 = ((new cljs.core.Keyword(null,"line","line",1017226086).cljs$core$IFn$_invoke$arity$1(ln) + new cljs.core.Keyword(null,"start","start",1123661780).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"meta","meta",1017252215).cljs$core$IFn$_invoke$arity$1(res))) + -1);lt.object.raise.call(null,editor,new cljs.core.Keyword(null,"editor.result","editor.result",4030217008),clojure.string.join.call(null," ",new cljs.core.Keyword(null,"values","values",4485058708).cljs$core$IFn$_invoke$arity$1(ln)),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"line","line",1017226086),lineNo_8295,new cljs.core.Keyword(null,"start-line","start-line",3689311729),lineNo_8295], null));
{
var G__8296 = seq__8281;
var G__8297 = chunk__8282;
var G__8298 = count__8283;
var G__8299 = (i__8284 + 1);
seq__8281 = G__8296;
chunk__8282 = G__8297;
count__8283 = G__8298;
i__8284 = G__8299;
...
{var c__7561__auto__ = cljs.core.chunk_first.call(null,seq__8281__$1);{
var G__8300 = cljs.core.chunk_rest.call(null,seq__8281__$1);
var G__8301 = c__7561__auto__;
var G__8302 = cljs.core.count.call(null,c__7561__auto__);
var G__8303 = 0;
seq__8281 = G__8300;
chunk__8282 = G__8301;
count__8283 = G__8302;
...
{var ln = cljs.core.first.call(null,seq__8281__$1);var lineNo_8304 = ((new cljs.core.Keyword(null,"line","line",1017226086).cljs$core$IFn$_invoke$arity$1(ln) + new cljs.core.Keyword(null,"start","start",1123661780).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"meta","meta",1017252215).cljs$core$IFn$_invoke$arity$1(res))) + -1);lt.object.raise.call(null,editor,new cljs.core.Keyword(null,"editor.result","editor.result",4030217008),clojure.string.join.call(null," ",new cljs.core.Keyword(null,"values","values",4485058708).cljs$core$IFn$_invoke$arity$1(ln)),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"line","line",1017226086),lineNo_8304,new cljs.core.Keyword(null,"start-line","start-line",3689311729),lineNo_8304], null));
{
...
var temp__4092__auto___8309 = new cljs.core.Keyword(null,"out","out",1014014656).cljs$core$IFn$_invoke$arity$1(res);if(cljs.core.truth_(temp__4092__auto___8309))
{var o_8310 = temp__4092__auto___8309;console.log(o_8310);
} else
{}
