...
lt.plugins.groovy.run_groovy = (function run_groovy(p__9105){var map__9107 = p__9105;var map__9107__$1 = ((cljs.core.seq_QMARK_.call(null,map__9107))?cljs.core.apply.call(null,cljs.core.hash_map,map__9107):map__9107);var info = map__9107__$1;var client = cljs.core.get.call(null,map__9107__$1,new cljs.core.Keyword(null,"client","client",3951159101));var name = cljs.core.get.call(null,map__9107__$1,new cljs.core.Keyword(null,"name","name",1017277949));var path = cljs.core.get.call(null,map__9107__$1,new cljs.core.Keyword(null,"path","path",1017337751));var obj = lt.object.create.call(null,new cljs.core.Keyword("lt.plugins.groovy","connecting-notifier","lt.plugins.groovy/connecting-notifier",2578157599),info);var client_id = lt.objs.clients.__GT_id.call(null,client);var project_dir = lt.objs.files.parent.call(null,path);lt.object.merge_BANG_.call(null,client,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"port","port",1017351155),lt.objs.clients.tcp.port,new cljs.core.Keyword(null,"proc","proc",1017353928),obj], null));
...
lt.plugins.groovy.notify = (function notify(obj){var map__9109 = obj;var map__9109__$1 = ((cljs.core.seq_QMARK_.call(null,map__9109))?cljs.core.apply.call(null,cljs.core.hash_map,map__9109):map__9109);var client = cljs.core.get.call(null,map__9109__$1,new cljs.core.Keyword(null,"client","client",3951159101));var groovy_server = cljs.core.get.call(null,map__9109__$1,new cljs.core.Keyword(null,"groovy-server","groovy-server",2729950548));var path = cljs.core.get.call(null,map__9109__$1,new cljs.core.Keyword(null,"path","path",1017337751));var groovy = cljs.core.get.call(null,map__9109__$1,new cljs.core.Keyword(null,"groovy","groovy",4071405440));if((cljs.core.not.call(null,groovy)) || (cljs.core.empty_QMARK_.call(null,groovy)))
...
lt.plugins.groovy.try_connect = (function try_connect(p__9110){var map__9112 = p__9110;var map__9112__$1 = ((cljs.core.seq_QMARK_.call(null,map__9112))?cljs.core.apply.call(null,cljs.core.hash_map,map__9112):map__9112);var info = cljs.core.get.call(null,map__9112__$1,new cljs.core.Keyword(null,"info","info",1017141280));var path = new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(info);var client = lt.objs.clients.client_BANG_.call(null,new cljs.core.Keyword(null,"groovy.client","groovy.client",3165568285));lt.plugins.groovy.check_all.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"path","path",1017337751),path,new cljs.core.Keyword(null,"client","client",3951159101),client], null));
return client;
});
...
lt.plugins.groovy.__BEH__eval_BANG_ = (function __BEH__eval_BANG_(this$,event){var map__9114 = event;var map__9114__$1 = ((cljs.core.seq_QMARK_.call(null,map__9114))?cljs.core.apply.call(null,cljs.core.hash_map,map__9114):map__9114);var origin = cljs.core.get.call(null,map__9114__$1,new cljs.core.Keyword(null,"origin","origin",4300251800));var info = cljs.core.get.call(null,map__9114__$1,new cljs.core.Keyword(null,"info","info",1017141280));var client = new cljs.core.Keyword(null,"default","default",2558708147).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"client","client",3951159101).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,origin)));lt.objs.notifos.working.call(null,"Evaluating groovy...");
...
var temp__4092__auto___9115 = new cljs.core.Keyword(null,"out","out",1014014656).cljs$core$IFn$_invoke$arity$1(res);if(cljs.core.truth_(temp__4092__auto___9115))
{var o_9116 = temp__4092__auto___9115;console.log(o_9116);
} else
{}
...
lt.plugins.groovy.__BEH__groovy_ok = (function __BEH__groovy_ok(editor,res){lt.objs.notifos.done_working.call(null);
console.log("Groovy fine");
var temp__4092__auto___9117 = new cljs.core.Keyword(null,"out","out",1014014656).cljs$core$IFn$_invoke$arity$1(res);if(cljs.core.truth_(temp__4092__auto___9117))
{var o_9118 = temp__4092__auto___9117;console.log(o_9118);
} else
{}
return lt.object.raise.call(null,editor,new cljs.core.Keyword(null,"editor.result","editor.result",4030217008),"\u2713",new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"line","line",1017226086),new cljs.core.Keyword(null,"end","end",1014004813).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"meta","meta",1017252215).cljs$core$IFn$_invoke$arity$1(res)),new cljs.core.Keyword(null,"start-line","start-line",3689311729),new cljs.core.Keyword(null,"start","start",1123661780).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"meta","meta",1017252215).cljs$core$IFn$_invoke$arity$1(res))], null));
});
lt.object.behavior_STAR_.call(null,new cljs.core.Keyword("lt.plugins.groovy","groovy-ok","lt.plugins.groovy/groovy-ok",4624583935),new cljs.core.Keyword(null,"reaction","reaction",4441361819),lt.plugins.groovy.__BEH__groovy_ok,new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"groovy.ok","groovy.ok",3660695342),null], null), null));
lt.plugins.groovy.__BEH__groovy_err = (function __BEH__groovy_err(editor,res){lt.objs.notifos.done_working.call(null);
var temp__4092__auto___9119 = new cljs.core.Keyword(null,"out","out",1014014656).cljs$core$IFn$_invoke$arity$1(res);if(cljs.core.truth_(temp__4092__auto___9119))
{var o_9120 = temp__4092__auto___9119;console.log(o_9120);
} else
{}
